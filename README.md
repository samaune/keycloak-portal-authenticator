...
[![main](https://github.com/samaune/keycloak-portal-authenticator/actions/workflows/maven.yml/badge.svg)](https://github.com/samaune/keycloak-portal-authenticator/actions/workflows/maven.yml)
![GitHub](https://img.shields.io/github/license/samaune/keycloak-portal-authenticator)

#### Supported Keycloak versions
| <img src="https://img.shields.io/badge/compatible_with_Keycloak-16.1.1-orange" alt="compatible with Keycloak - 16.1.1"> | [`keycloak-portal-authenticator:0.3.0`](https://github.com/samaune/keycloak-portal-authenticator/tree/0.3.0) |
|-------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| <img src="https://img.shields.io/badge/compatible_with_Keycloak-24.0.1-blue" alt="compatible with Keycloak - 24.0.1">   | [`keycloak-portal-authenticator:1.0.1`](https://github.com/samaune/keycloak-portal-authenticator/tree/main)  |
...
RUN curl -s -L -o /opt/keycloak/providers/keycloak-portal-authenticator-1.0.1.jar https://github.com/samaune/keycloak-portal-authenticator/releases/download/1.0.1/keycloak-portal-authenticator-1.0.1.jar
